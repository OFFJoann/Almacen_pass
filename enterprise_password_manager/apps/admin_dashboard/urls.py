...
urlpatterns = [
    ...
    path('obsolete/password/<uuid:pk>/restore/', views.obsolete_restore_password, name='obsolete_restore_password'),
    path('obsolete/secret/<uuid:pk>/delete/', views.obsolete_delete_secret, name='obsolete_delete_secret'),
    path('obsolete/secret/<uuid:pk>/restore/', views.obsolete_restore_secret, name='obsolete_restore_secret'),
